...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/char.js":[function(require,module,exports) {
"use strict";
...
var Champion = /*#__PURE__*/_createClass(function Champion(data) {
  _classCallCheck(this, Champion);
  this.id = data.id;
  this.name = data.name;
  this.blurb = data.blurb;
  this.image = "http://ddragon.leagueoflegends.com/cdn/13.18.1/img/champion/".concat(this.id);
  this.tags = data.tags;
  this.info = data.info; // Información adicional del campeón
  this.title = data.title;
});
var _default = exports.default = Champion;
},{}],"js/index.js":[function(require,module,exports) {
"use strict";

var _char = _interopRequireDefault(require("./char.js"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
document.getElementById('load-champions').addEventListener('click', function () {
  var url = "https://ddragon.leagueoflegends.com/cdn/13.18.1/data/es_ES/champion.json";
  fetch(url).then(function (response) {
    ...
    return console.error('Error al cargar los campeones:', error);
  });
});
},{"./char.js":"js/char.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
